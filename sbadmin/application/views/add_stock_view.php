...
<div class="row">
  <div class="col-lg-6 col-md-6">
    <form method="post" id="form-pendaftaran" enctype="multipart/form-data" action="<?php echo base_url();?>index.php/admin/update_stok">
      <div class="row">
        <div class="col-lg-4 col-md-4">
          <div class="form-group">
              <label>ID Obat</label>
              <input class="form-control"  name="id_obat" value="<?php echo $detil->id_obat ?>" readonly="readonly"  >
