    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Aplikasi Apotik</a>
            </div>
            <!-- Top Menu Items -->
                ...
                <ul class="nav navbar-nav side-nav">
                  ...
                  <li>
                        ...
                        <ul id="demo" class="collapse">
                          <li>
                              <a href="<?php echo base_url();?>index.php/admin/obat"> Obat</a>
                          </li>
                          <li>
                              <a href="<?php echo base_url();?>index.php/admin/laporan_jual"> Laporan Jual</a>
                          </li>
                        </ul>
                    </li>
            <!-- Super Admin -->
            <?php if ($jabatan == 'admin') {
              echo '<li>
                  <a href="'.base_url().'index.php/admin/suplier"> Suplier</a>
              </li>
              <li>
